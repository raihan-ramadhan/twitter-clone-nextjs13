...
export function FollowButton({
  ...
  return (
    <>
      <Modal
        modalClassName="flex flex-col gap-6 max-w-xs bg-main-background-1 w-full p-8 rounded-2xl"
        open={open}
        closeModal={() => {
          closeModal();
        }}
      ...
      {userIsFollowed ? (
        <Button
          className='dark-bg-tab min-w-[106px] self-start border border-light-line-reply !px-4 !py-1 
        ...
        <Button
          className="self-start border bg-light-primary !px-4 !py-1 font-bold text-white hover:bg-light-primary/90 
